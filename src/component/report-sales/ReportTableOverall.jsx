...
const ReportTableOverall = () => {
  ...
  useEffect(() => {
    if (all_report != null) {
      ...
      all_report.forEach((item) => {
        totalPendapatanKeseluruhan += item.harga_produk * item.terjual;
        totalTerjualKeseluruhan += item.terjual;
      });
      setTotalProdukKeseluruhan(totalPendapatanKeseluruhan);
      setTotalProdukTerjual(totalTerjualKeseluruhan);
    }
  }, [all_report]);
  ...
  return (
    <>
      <h3 className="text-center text-primary mb-4 title-laporan-keseluruhan">
      ...
      <Table bordered hover responsive className="">
        <thead>
          <tr className="text-center">
            ...
            <th scope="col" className="text-primary" style={{ width: "20%" }}>
              Nama Produk
            </th>
            <th scope="col" className="text-primary">
              Harga Produk
            ...
            <th scope="col" className="text-primary" style={{ width: "15%" }}>
              Nama Pelanggan
            </th>
            <th scope="col" className="text-primary" style={{ width: "30%" }}>
              Nomor Pesanan
            </th>
            <th scope="col" className="text-primary">
              Terjual
        ...
        <tbody>
          {all_report == null || all_report?.length == 0 ? (
            <tr className="text-center fs-5">
              ...
              >
                Tidak ada produk di laporan penjualan keseluruhan
              </td>
            </tr>
          ) : (
            all_report?.map((item) => (
      ...
      <div className="row mb-5 mt-4 gy-3">
        <div className="col-12">
          <h3 className="text-primary ringkasan-laporan-title">
            Rinkasan Laporan Keseluruhan
          </h3>
        </div>
        <div className="col-12 d-flex gap-4 p-0 mx-2 bg-primary rounded report-overall">
...
export default ReportTableOverall;
